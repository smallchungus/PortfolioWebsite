        ...
        <div>
          ...
          <div className="mt-12" data-testid="education-section">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <h4 className="font-semibold text-gray-900 dark:text-white">Master's in Computer Science</h4>
              <p className="text-gray-600 dark:text-gray-300 mt-1">Arizona State University</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Current Student • GPA 4.0</p>
            </div>
          </div>
        </div>
